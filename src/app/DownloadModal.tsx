import { Avatar, Divider, List, ListItem, ListItemAvatar, ListItemText, Modal, Typography } from '@material-ui/core';
        ...
        >
            <div className="remove-focus">
                ...
                <List>
                    {DATASETS.map((item) => (
                        <>
                            <DownloadItem key={item.id} {...item}></DownloadItem>
                        </>
                    ))}
                </List>
            </div>
...
function DownloadItem(props: DownloadItemPropTypes) {
    ...
    return (
        ...
        >
            ...
            >
                <div className={'progress-check' + (done ? ' progress-check-done' : '')} hidden={!done}>
                    <Check></Check>
                </div>
            </div>

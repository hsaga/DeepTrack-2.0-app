...
import type, { TextareaProps, TextareaState, caretPositionType, outputType, triggerType, settingType } from './types';
...
const escapeRegex = (text) =>
    [...text].map((character) => (reservedRegexChars.includes(character) ? `\\${character}` : character)).join('');
